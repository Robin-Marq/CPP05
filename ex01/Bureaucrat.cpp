...
/*   Updated: 2024/04/19 11:01:29 by rmarquar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat::Bureaucrat(const std::string &name, int grade) : _name(name), _grade(grade)
{
	...
	std::cout << GREEN << "Parameter constructor called" << std::endl;
}
...
void Bureaucrat::signForm(Form &form)
{
	...
	{
		std::cout << "Bureaucrat " << this->getName() << " cannot sign " << form.getName() << " because his grade is too low" << std::endl;
	}
	else
	{
		form.beSigned(*this);
