...
/*   Updated: 2024/04/17 12:03:30 by rmarquar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    output << "Bureaucrat " << bureaucrat.getName() << ", grade " << bureaucrat.getGrade() << std::endl;
    return output;
}
...
void Bureaucrat::signForm(AForm &form)
{
	...
	{
		std::cout << "Bureaucrat " << this->getName() << " cannot sign " << form.getName() << " grade is too low" << std::endl;
	}
	else
	{
		form.beSigned(*this);
